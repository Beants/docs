...
3. Optional: install `cc-codex-spec-bootstrap` from the marketplace, where Claude Code and Codex draft first-pass specs from real code. Install with `npx skills add mindfold-ai/marketplace --skill cc-codex-spec-bootstrap`.
...
| Main-session skill flow | Codex inline, Kilo, Antigravity, Windsurf           | The main session loads Trellis skills and reads `prd.md`, optional artifacts, and relevant specs inline.                                          |
