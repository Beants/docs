...
- `.codex/skills/`, `.codex/agents/` (TOML), `.codex/hooks/`, `AGENTS.md`
- `.kiro/steering/`, `.kiro/prompts/`, `.kiro/skills/`, `.kiro/agents/`
- `.gemini/commands/trellis/` (TOML), `.gemini/agents/`, `.gemini/hooks/`
