...
| Dynamic spec loading           |     ✅      |  pull  |    ✅    |  ✅   | pull |  pull  | pull  |   pull    |  pull   | pull  |    ✅    |   pull   |
| Sub-agents (`trellis-*`)       |     ✅      |   ✅   |    ✅    |  ✅   |  ✅  |   ✅   |  ✅   |    ✅     |   ✅    |  ✅   |    ✅    |    ✅    |
| Auto-trigger skills            |     ✅      |   ✅   |    ✅    |  ✅   |  ✅  |   ✅   |  ✅   |    ✅     |   ✅    |  ✅   |    ✅    |    ✅    |
...
environment propagation, sub-agent context injection, and dynamic spec loading
are handled by the extension. `pull` means the platform can resolve governing spec paths through
