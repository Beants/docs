...
本文档从一个新 AI 会话开始，一直走到任务归档，说明 Trellis 的标准流程。
...
这一步结束后，AI 应该知道 Trellis 上下文在哪里。具体 phase 细节通过
...
`.trellis/tasks/` 下的任何内容前取得 task-creation consent。
...
3. 可选：安装 marketplace 提供的 `cc-codex-spec-bootstrap`，让 Claude Code 和 Codex 从真实代码生成第一版 specs。安装命令：`npx skills add mindfold-ai/marketplace --skill cc-codex-spec-bootstrap`。
